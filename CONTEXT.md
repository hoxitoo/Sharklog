...
- **CI**: `.github/workflows/ci.yml` — `npm ci` → vitest (core 176 + desktop 40) → mobile tests (34) → tsc mobile+desktop
...
```
packages/core         176 vitest unit tests (stats, analytics, daily, formatters, kelly, migrations,
                          ...
                          luckAndPlan x16 — сигма-модель везения и соблюдение плана)
