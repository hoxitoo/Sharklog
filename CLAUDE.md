...
screens/
  BetsScreen/              — SectionList + quick-result W/L/R/C (cashout)
                             ...
                             исчезает, а сворачивается в плавающий трей (пилюля вверху:
                             активный статус · P&L дня · тап = назад к верху). Два слоя на
                             одном Animated.Value 0..1, оба на нативном драйвере; невидимый
                             слой обязан быть pointerEvents:'none', иначе съедает тапы.
